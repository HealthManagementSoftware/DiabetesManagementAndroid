package com.healthmanagement.diabetesassistant.contentproviders;
...
public class DAContentProvider extends ContentProvider
{
    // fields for content provider
    public static final String
            AUTHORITY            = "com.healthmanagement.diabetesassistant.provider",
            ...
            NOTICES_URL          = "content://" + AUTHORITY + "/" + DB.TABLE_HIPAA_NOTICES,
            PSHN_URL             = "content://" + AUTHORITY + "/" + DB.TABLE_PATIENT_SIGNED_HIPAA;
    ...
    public static final Uri
            ...
            NOTICES_URI          = Uri.parse( NOTICES_URL ),
            PSHN_URI             = Uri.parse( PSHN_URL );
    ...
    static
    {
        ...
        uriMatcher.addURI( AUTHORITY, DB.TABLE_HIPAA_NOTICES, NOTICES );
        uriMatcher.addURI( AUTHORITY, DB.TABLE_HIPAA_NOTICES + "/#", NOTICES_ID );
        uriMatcher.addURI( AUTHORITY, DB.TABLE_PATIENT_SIGNED_HIPAA, PSHN );
        uriMatcher.addURI( AUTHORITY, DB.TABLE_PATIENT_SIGNED_HIPAA + "/#", PSHN_ID );
            ...
            @Nullable String sortOrder )
    {
        ...
        switch ( uriMatcher.match( uri ) )
        {
            ...
            case NOTICES:
                queryBuilder.setTables( DB.TABLE_HIPAA_NOTICES );
                break;
            ...
            case PSHN:
                queryBuilder.setTables( DB.TABLE_PATIENT_SIGNED_HIPAA );
                break;
                       ...
                       @Nullable ContentValues values )
    {
        ...
        switch ( uriMatcher.match( uri ) )
        {
            ...
            case NOTICES:
                count = database.insert( DB.TABLE_HIPAA_NOTICES, AUTHORITY, values );
                break;

            case PSHN:
                Log.d( LOG_TAG, values.toString() );
                count = database.insert( DB.TABLE_PATIENT_SIGNED_HIPAA, AUTHORITY, values );
                break;
                       ...
                       @Nullable String[] selectionArgs )
    {
        ...
        switch ( uriMatcher.match( uri ) )
        {
            ...
            case PSHN:
                count = database.delete( DB.TABLE_PATIENT_SIGNED_HIPAA, selection, selectionArgs );
                break;

            case PSHN_ID:
                count = database.delete(
                        DB.TABLE_PATIENT_SIGNED_HIPAA, DB.KEY_ID + " = " + uri.getLastPathSegment() +
                                ( !TextUtils.isEmpty( selection ) ? " AND (" + selection + ')' : "" ),
                        selectionArgs );
                break;

            case NOTICES:
                count = database.delete( DB.TABLE_HIPAA_NOTICES, selection, selectionArgs );
                break;

            case NOTICES_ID:
                count = database.delete(
                        DB.TABLE_HIPAA_NOTICES, DB.KEY_ID + " = " + uri.getLastPathSegment() +
                                ( !TextUtils.isEmpty( selection ) ? " AND (" + selection + ')' : "" ),
                        selectionArgs );
                break;
                       ...
                       @Nullable String[] selectionArgs )
    {
        ...
        switch ( uriMatcher.match( uri ) )
        {
            ...
            case PEDOMETER:
                count = database.update( DB.TABLE_PEDOMETER, values, selection, selectionArgs );
                break;

            case PSHN:
                count = database.update( DB.TABLE_PATIENT_SIGNED_HIPAA, values,
                        selection, selectionArgs );
                break;

            case PSHN_ID:
                count = database.update( DB.TABLE_PATIENT_SIGNED_HIPAA,
                        values,
                        DB.KEY_ID + "=?" + ( !TextUtils.isEmpty( selection )
                                ? " AND (" + selection + ')' : "" ),
                        new String[]{ uri.getLastPathSegment() } );
                break;

            case NOTICES:
                count = database.update( DB.TABLE_HIPAA_NOTICES, values,
                        selection, selectionArgs );
                break;

            case NOTICES_ID:
                count = database.update( DB.TABLE_HIPAA_NOTICES,
                        values,
                        DB.KEY_ID + "=?" + ( !TextUtils.isEmpty( selection )
                                ? " AND (" + selection + ')' : "" ),
                        new String[]{ uri.getLastPathSegment() } );
    ...
    public String getType( @NonNull Uri uri )
    {
        switch ( uriMatcher.match( uri ) )
        {
            case USERS:
                ...
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.users";
            case USERS_ID:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.usersid";
            case PATIENTS:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.patients";
            case PATIENT_USERS:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.patient_users";
            case PATIENTS_ID:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.patientsid";
            case DOCTORS:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.doctors";
            case DOCTORS_ID:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.doctorsid";
            case DOCTOR_USERS:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.doctor_users";
            case GLUCOSE_ENTRIES:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.glucoseentries";
            case GLUCOSE_ENTRIES_ID:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.glucoseentriesid";
            case MEAL_ENTRIES:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.mealentries";
            case MEAL_ENTRIES_ID:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.mealentriesid";
            case MEAL_ENTRY_ITEMS:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.mealentryitems";
            case MEAL_ITEMS:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.mealitems";
            case MEAL_ITEMS_ID:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.mealitemsid";
            case EXERCISE_ENTRIES:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.exerciseentries";
            case EXERCISE_ENTRIES_ID:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.exerciseentriesid";
            case PEDOMETER:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.pedometer";
            case PSHN:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.pshn";
            case PSHN_ID:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.pshnid";
            case NOTICES:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.notices";
            case NOTICES_ID:
                return "com.healthmanagement.diabetesassistant/com.healthmanagement.diabetesassistant.noticesid";
            default:
